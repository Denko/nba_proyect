...
renamed_casted AS (
    SELECT
        ...
        {{dbt_utils.generate_surrogate_key(['HOME_TEAM_ID'])}}::varchar(256) as game_home_team_id, 
        {{dbt_utils.generate_surrogate_key(['VISITOR_TEAM_ID'])}}::varchar(256) as game_visitor_team_id, 
